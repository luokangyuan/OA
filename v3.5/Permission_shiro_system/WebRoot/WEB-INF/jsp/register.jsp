				...
				<TABLE class="tab" border="0" cellSpacing="6" cellPadding="8">
					<TBODY class="my_table">
						...
						<TR>
							...
							<TD><input type="password" id="npwd" name="password" style="WIDTH: 150px;height:30px" />
							</TD>
						</TR>
						<TR>
						...
						<TR>
							<TD colSpan="2" align="center">
								<input style="background:#3987D8" type="button"class="btnalink" onclick="loginsubmit()" value="确&nbsp;&nbsp;认" />
								<input style="background:#3987D8" type="reset" class="btnalink" value="重&nbsp;&nbsp;置" /></TD>
						</TR>
					</TBODY>
				</TABLE>
